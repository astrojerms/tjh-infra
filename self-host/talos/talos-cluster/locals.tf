locals {
  ...
  vm_master_nodes = {
    "0" = {
      ...
      clone_target   = "talos-v1.7.2-cloud-init-template"
      node_cpu_cores = "4"
      node_memory    = 2048
      node_ipconfig  = "gw=172.30.1.1,ip=172.30.250.170/16"
      node_disk      = "32" # in GB
    }
    # "1" = {
    #   vm_id          = 201
  ...
  vm_worker_nodes = {
    "0" = {
      ...
      node_cpu_cores       = "4"
      node_memory          = 6144
      node_ipconfig        = "gw=172.30.1.1,ip=172.30.250.180/16"
      node_disk            = "32"
    ...
    "1" = {
      ...
      node_cpu_cores       = "4"
      node_memory          = 6144
      node_ipconfig        = "gw=172.30.1.1,ip=172.30.250.181/16"
      node_disk            = "32"
      additional_node_disk = "128" # for longhorn
    }
    # "2" = {
